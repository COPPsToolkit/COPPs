...
run('IndividualProjections\Run_COPPs_Fig_13_a')
projections_all.simple_rules = projections.simple_rules; 
projections_all.COPPs_13a = projections.COPPs; 
save('FigureInfo','projections_all')
%% Run individual script
run('IndividualProjections\Run_COPPs_Fig_13_b')
load('FigureInfo','projections_all')
projections_all.COPPs_13b = projections.COPPs; 
save('FigureInfo','projections_all')
%% Load relevant info
clear
load('FigureInfo')
...
params.plotting.Data = {projections_all.simple_rules.data   , '-'  , 1 ,[0,0,0], 'Baseline' ; ...
        projections_all.COPPs_13a.data          , ':' , 1 ,[0,0,1], 'SWu20: rates only'; ...
        projections_all.COPPs_13b.data          , '--' , 1 ,[0,1,0], 'SWu20: qe only'; ...
        };
